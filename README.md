# Restructure Hotel Debt

Audience-specific landing site for **restructurehoteldebt.com**, bundling the Hotel Capital Stack diagnostic. Static — no build step.
...
```bash
git init && git add . && git commit -m "Restructure Hotel Debt site"
git branch -M main
gh repo create moonman312/restructure-site --public --source=. --remote=origin --push
vercel && vercel --prod
```

## Domains for this project (add in Vercel → Settings → Domains)
- Primary: **restructurehoteldebt.com**
- (no secondary domains)
